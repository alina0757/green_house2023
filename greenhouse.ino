...
#include <Wire.h>                      ///////////////////////////////
#include <SPI.h>                       //     конфигурация блинка   //
//////////////////////////////////////////////////////////////////////
#include <Servo.h>                     //  конфигурация сервомотора //
////////////////////////////////////////////////////////////////////////////////////
...
char auth[] = "4a7c974100bf4153a9f301c0854988fd"; // Authorization token //
...
//////////////////////////////////////////////////////////////////////////////////////////////////
#include <BH1750FVI.h>        //             добавляем библиотеку датчика освещенности          //
BH1750FVI LightSensor_1;      //                               BH1750                           //
//////////////////////////////////////////////////////////////////////////////////////////////////
#include <Adafruit_Sensor.h>  // добавляем библиотеку датчика температуры, влажности и давления //
...
////////////////////////////////////////////////////
  pinMode( pump, OUTPUT );                             // настройка пинов насоса и вентилятора на выход 
  pinMode( wind, OUTPUT );
...
/////////////////////////////////////////////////////
  LightSensor_1.begin();                                          // запуск датчика освещенности 
...
BLYNK_WRITE(V2)
{
  ...
  int b = param[2].asInt();                            //            B  параметров               
